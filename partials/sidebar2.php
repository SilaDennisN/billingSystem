                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseDashboards" aria-labelledby="headingOne" data-bs-parent="#drawerAccordion">
                                <nav class="drawer-menu-nested nav">
                                    ...
                                    <a class="nav-link active" href="app-dashboard-minimal.html">Minimal</a>
                                    <a class="nav-link active mdc-ripple-upgraded" href="app-dashboard-analytics.html">Analytics</a>
